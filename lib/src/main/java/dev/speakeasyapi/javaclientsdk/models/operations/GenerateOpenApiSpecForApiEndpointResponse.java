...
public class GenerateOpenApiSpecForApiEndpointResponse {
     ...
     * Default error response
     */
    public GenerateOpenApiSpecForApiEndpointResponse withError(Optional<? extends dev.speakeasyapi.javaclientsdk.models.shared.Error> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
     ...
     * OK
     */
    public GenerateOpenApiSpecForApiEndpointResponse withGenerateOpenApiSpecDiff(Optional<? extends dev.speakeasyapi.javaclientsdk.models.shared.GenerateOpenApiSpecDiff> generateOpenApiSpecDiff) {
        Utils.checkNotNull(generateOpenApiSpecDiff, "generateOpenApiSpecDiff");
        this.generateOpenApiSpecDiff = generateOpenApiSpecDiff;
        return this;
    }
