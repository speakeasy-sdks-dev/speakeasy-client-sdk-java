...
public class GetAllForVersionApiEndpointsResponse {
     ...
     * OK
     */
    public GetAllForVersionApiEndpointsResponse withAPIEndpoints(java.util.List<dev.speakeasyapi.javaclientsdk.models.shared.ApiEndpoint> apiEndpoints) {
        Utils.checkNotNull(apiEndpoints, "apiEndpoints");
     ...
     * OK
     */
    public GetAllForVersionApiEndpointsResponse withAPIEndpoints(Optional<? extends java.util.List<dev.speakeasyapi.javaclientsdk.models.shared.ApiEndpoint>> apiEndpoints) {
        Utils.checkNotNull(apiEndpoints, "apiEndpoints");
        this.apiEndpoints = apiEndpoints;
        return this;
    }
