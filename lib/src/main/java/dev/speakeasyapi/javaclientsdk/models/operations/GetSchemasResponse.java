...
public class GetSchemasResponse {
     ...
     * OK
     */
    private Optional<? extends java.util.List<dev.speakeasyapi.javaclientsdk.models.shared.Schema>> classes;
    ...
    public GetSchemasResponse(
            ...
            Optional<? extends java.util.List<dev.speakeasyapi.javaclientsdk.models.shared.Schema>> classes) {
     ...
     * OK
     */
    public Optional<? extends java.util.List<dev.speakeasyapi.javaclientsdk.models.shared.Schema>> classes() {
        return classes;
    }
     ...
     * Default error response
     */
    public GetSchemasResponse withError(Optional<? extends dev.speakeasyapi.javaclientsdk.models.shared.Error> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
     ...
     * OK
     */
    public GetSchemasResponse withClasses(java.util.List<dev.speakeasyapi.javaclientsdk.models.shared.Schema> classes) {
        Utils.checkNotNull(classes, "classes");
     ...
     * OK
     */
    public GetSchemasResponse withClasses(Optional<? extends java.util.List<dev.speakeasyapi.javaclientsdk.models.shared.Schema>> classes) {
        Utils.checkNotNull(classes, "classes");
        this.classes = classes;
        return this;
    }
    ...
    public final static class Builder {
        ...
        private Optional<? extends java.util.List<dev.speakeasyapi.javaclientsdk.models.shared.Schema>> classes = Optional.empty();  
         ...
         * OK
         */
        public Builder classes(java.util.List<dev.speakeasyapi.javaclientsdk.models.shared.Schema> classes) {
            Utils.checkNotNull(classes, "classes");
            this.classes = Optional.ofNullable(classes);
            return this;
        }
         ...
         * OK
         */
        public Builder classes(Optional<? extends java.util.List<dev.speakeasyapi.javaclientsdk.models.shared.Schema>> classes) {
            Utils.checkNotNull(classes, "classes");
            this.classes = classes;
            return this;
        }        
