...
public class GetRequestFromEventLogResponse {
    ...
    public GetRequestFromEventLogResponse withError(io.github.openapi-sdks.javaclientsdk.models.shared.Error error) {
        this.error = error;
        return this;
    }
    ...
    public io.github.openapi-sdks.javaclientsdk.models.shared.UnboundedRequest unboundedRequest;
    public GetRequestFromEventLogResponse withUnboundedRequest(io.github.openapi-sdks.javaclientsdk.models.shared.UnboundedRequest unboundedRequest) {
