...
public class GetAllApiEndpointsResponse {
    ...
    public GetAllApiEndpointsResponse withApiEndpoints(io.github.openapi-sdks.javaclientsdk.models.shared.ApiEndpoint[] apiEndpoints) {
    ...
    public GetAllApiEndpointsResponse withError(io.github.openapi-sdks.javaclientsdk.models.shared.Error error) {
        this.error = error;
        return this;
    }
