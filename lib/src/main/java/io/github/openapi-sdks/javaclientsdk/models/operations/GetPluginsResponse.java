...
public class GetPluginsResponse {
    ...
    public GetPluginsResponse withError(io.github.openapi-sdks.javaclientsdk.models.shared.Error error) {
        this.error = error;
        return this;
    }
    
    public io.github.openapi-sdks.javaclientsdk.models.shared.Plugin[] plugins;
    public GetPluginsResponse withPlugins(io.github.openapi-sdks.javaclientsdk.models.shared.Plugin[] plugins) {
