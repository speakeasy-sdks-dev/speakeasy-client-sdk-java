...
public class GetSchemaRevisionResponse {
    ...
    public GetSchemaRevisionResponse withError(io.github.openapi-sdks.javaclientsdk.models.shared.Error error) {
        this.error = error;
        return this;
    }
    
    public io.github.openapi-sdks.javaclientsdk.models.shared.Schema schema;
    public GetSchemaRevisionResponse withSchema(io.github.openapi-sdks.javaclientsdk.models.shared.Schema schema) {
        this.schema = schema;
        return this;
    }
