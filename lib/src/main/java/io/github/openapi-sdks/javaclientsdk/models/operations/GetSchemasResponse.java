...
public class GetSchemasResponse {
    ...
    public GetSchemasResponse withError(io.github.openapi-sdks.javaclientsdk.models.shared.Error error) {
        this.error = error;
        return this;
    }
    
    public io.github.openapi-sdks.javaclientsdk.models.shared.Schema[] schemata;
    public GetSchemasResponse withSchemata(io.github.openapi-sdks.javaclientsdk.models.shared.Schema[] schemata) {
