...
public class RunPluginResponse {
    ...
    public RunPluginResponse withBoundedRequests(io.github.openapi-sdks.javaclientsdk.models.shared.BoundedRequest[] boundedRequests) {
    ...
    public RunPluginResponse withError(io.github.openapi-sdks.javaclientsdk.models.shared.Error error) {
        this.error = error;
        return this;
    }
