...
public class GetAllApiVersionsResponse {
    ...
    public GetAllApiVersionsResponse withApis(io.github.openapi-sdks.javaclientsdk.models.shared.Api[] apis) {
        this.apis = apis;
        return this;
    }
    ...
    public GetAllApiVersionsResponse withError(io.github.openapi-sdks.javaclientsdk.models.shared.Error error) {
        this.error = error;
        return this;
    }
