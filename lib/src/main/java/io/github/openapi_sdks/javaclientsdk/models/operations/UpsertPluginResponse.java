...
public class UpsertPluginResponse {
    ...
    public UpsertPluginResponse withError(io.github.openapi_sdks.javaclientsdk.models.shared.Error error) {
        this.error = error;
        return this;
    }
    
    public io.github.openapi_sdks.javaclientsdk.models.shared.Plugin plugin;
    public UpsertPluginResponse withPlugin(io.github.openapi_sdks.javaclientsdk.models.shared.Plugin plugin) {
        this.plugin = plugin;
        return this;
    }
