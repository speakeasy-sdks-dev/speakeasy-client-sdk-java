...
public class QueryEventLogResponse {
    ...
    public QueryEventLogResponse withBoundedRequests(io.github.openapi_sdks.javaclientsdk.models.shared.BoundedRequest[] boundedRequests) {
    ...
    public QueryEventLogResponse withError(io.github.openapi_sdks.javaclientsdk.models.shared.Error error) {
        this.error = error;
        return this;
    }
