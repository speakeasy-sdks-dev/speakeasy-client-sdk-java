...
public class GetAllForVersionApiEndpointsResponse {
    ...
    public GetAllForVersionApiEndpointsResponse withApiEndpoints(io.github.openapi_sdks.javaclientsdk.models.shared.ApiEndpoint[] apiEndpoints) {
    ...
    public GetAllForVersionApiEndpointsResponse withError(io.github.openapi_sdks.javaclientsdk.models.shared.Error error) {
        this.error = error;
        return this;
    }
