...
public class GetApisResponse {
    ...
    public GetApisResponse withApis(io.github.openapi_sdks.javaclientsdk.models.shared.Api[] apis) {
        this.apis = apis;
        return this;
    }
    ...
    public GetApisResponse withError(io.github.openapi_sdks.javaclientsdk.models.shared.Error error) {
        this.error = error;
        return this;
    }
