...
public class GetVersionMetadataResponse {
    ...
    public GetVersionMetadataResponse withError(io.github.openapi_sdks.javaclientsdk.models.shared.Error error) {
        this.error = error;
        return this;
    }
    ...
    public GetVersionMetadataResponse withVersionMetadata(io.github.openapi_sdks.javaclientsdk.models.shared.VersionMetadata[] versionMetadata) {
