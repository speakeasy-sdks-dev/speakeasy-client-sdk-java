...
import io.github.openapi_sdks.javaclientsdk.utils.SpeakeasyHTTPClient;
...
public class SDK {
	...
	private String _sdkVersion = "1.4.11";
	private String _genVersion = "1.4.8";

	public static class Builder {
		private HTTPClient client;
		private io.github.openapi_sdks.javaclientsdk.models.shared.Security security;
		...
		public Builder setSecurity(io.github.openapi_sdks.javaclientsdk.models.shared.Security security) {
	...
	private SDK(HTTPClient client, io.github.openapi_sdks.javaclientsdk.models.shared.Security security, String serverUrl, java.util.Map<String, String> params) throws Exception {
		...
		if (security != null) {
			...
			this._securityClient = io.github.openapi_sdks.javaclientsdk.utils.Utils.configureSecurityClient(this._defaultClient, this._security);
		}
		...
		if (serverUrl != null && !serverUrl.isBlank()) {
			this._serverUrl = io.github.openapi_sdks.javaclientsdk.utils.Utils.replaceParameters(serverUrl, params);
		}
    ...
    **/
    public io.github.openapi_sdks.javaclientsdk.models.operations.ValidateApiKeyResponse validateApiKey() throws Exception {
        String baseUrl = this._serverUrl;
        String url = io.github.openapi_sdks.javaclientsdk.utils.Utils.generateURL(baseUrl, "/v1/auth/validate");
        ...
        io.github.openapi_sdks.javaclientsdk.models.operations.ValidateApiKeyResponse res = new io.github.openapi_sdks.javaclientsdk.models.operations.ValidateApiKeyResponse() {{
            error = null;
        }};
