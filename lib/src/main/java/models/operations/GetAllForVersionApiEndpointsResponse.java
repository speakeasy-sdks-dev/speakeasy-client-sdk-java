...
public class GetAllForVersionApiEndpointsResponse {
    ...
    public GetAllForVersionApiEndpointsResponse withApiEndpoints(.models.shared.ApiEndpoint[] apiEndpoints) {
    ...
    public GetAllForVersionApiEndpointsResponse withError(.models.shared.Error error) {
        this.error = error;
        return this;
    }
