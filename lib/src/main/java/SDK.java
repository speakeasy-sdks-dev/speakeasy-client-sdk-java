...
public class SDK {
    ...
    **/
    public .models.operations.ValidateApiKeyResponse validateApiKey() throws Exception {
        String baseUrl = this._serverUrl;
        String url = .utils.Utils.generateURL(baseUrl, "/v1/auth/validate");
        ...
        .models.operations.ValidateApiKeyResponse res = new .models.operations.ValidateApiKeyResponse() {{
            error = null;
        }};
