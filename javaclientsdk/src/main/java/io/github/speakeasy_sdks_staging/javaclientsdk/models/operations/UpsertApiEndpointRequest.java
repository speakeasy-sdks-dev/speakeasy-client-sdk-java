...
public class UpsertApiEndpointRequest {
    ...
    public UpsertApiEndpointRequest(@JsonProperty("ApiEndpoint") io.github.speakeasy_sdks_staging.javaclientsdk.models.shared.ApiEndpointInput apiEndpoint, @JsonProperty("apiEndpointID") String apiEndpointID, @JsonProperty("apiID") String apiID, @JsonProperty("versionID") String versionID) {
        this.apiEndpoint = apiEndpoint;
        this.apiEndpointID = apiEndpointID;
        this.apiID = apiID;
        this.versionID = versionID;
