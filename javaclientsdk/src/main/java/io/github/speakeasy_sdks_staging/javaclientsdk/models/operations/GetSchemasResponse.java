...
public class GetSchemasResponse {
    ...
    public GetSchemasResponse withError(io.github.speakeasy_sdks_staging.javaclientsdk.models.shared.Error error) {
        this.error = error;
        return this;
    }
    ...
    public io.github.speakeasy_sdks_staging.javaclientsdk.models.shared.Schema[] classes;

    public GetSchemasResponse withClasses(io.github.speakeasy_sdks_staging.javaclientsdk.models.shared.Schema[] classes) {
