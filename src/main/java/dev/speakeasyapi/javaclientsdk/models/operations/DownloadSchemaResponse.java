...
public class DownloadSchemaResponse implements Response {
     ...
     * Default error response
     */
    public DownloadSchemaResponse withError(Error error) {
        Utils.checkNotNull(error, "error");
     ...
     * Default error response
     */
    public DownloadSchemaResponse withError(Optional<? extends Error> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
