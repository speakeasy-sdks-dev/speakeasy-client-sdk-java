...
public class GenerateRequestPostmanCollectionResponse implements Response {
     ...
     * Default error response
     */
    public GenerateRequestPostmanCollectionResponse withError(Error error) {
        Utils.checkNotNull(error, "error");
     ...
     * Default error response
     */
    public GenerateRequestPostmanCollectionResponse withError(Optional<? extends Error> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
