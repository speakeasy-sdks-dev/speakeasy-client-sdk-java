...
public class GetSchemaResponse implements Response {
     ...
     * Default error response
     */
    public GetSchemaResponse withError(Error error) {
        Utils.checkNotNull(error, "error");
     ...
     * Default error response
     */
    public GetSchemaResponse withError(Optional<? extends Error> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
     ...
     * OK
     */
    public GetSchemaResponse withSchema(Schema schema) {
        Utils.checkNotNull(schema, "schema");
     ...
     * OK
     */
    public GetSchemaResponse withSchema(Optional<? extends Schema> schema) {
        Utils.checkNotNull(schema, "schema");
        this.schema = schema;
        return this;
    }
