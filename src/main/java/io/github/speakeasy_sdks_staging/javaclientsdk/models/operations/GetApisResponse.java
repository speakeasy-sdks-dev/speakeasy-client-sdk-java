...
public class GetApisResponse implements Response {
     ...
     * OK
     */
    public GetApisResponse withApis(List<Api> apis) {
        Utils.checkNotNull(apis, "apis");
     ...
     * OK
     */
    public GetApisResponse withApis(Optional<? extends List<Api>> apis) {
        Utils.checkNotNull(apis, "apis");
        this.apis = apis;
        return this;
    }
     ...
     * Default error response
     */
    public GetApisResponse withError(Error error) {
        Utils.checkNotNull(error, "error");
     ...
     * Default error response
     */
    public GetApisResponse withError(Optional<? extends Error> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
