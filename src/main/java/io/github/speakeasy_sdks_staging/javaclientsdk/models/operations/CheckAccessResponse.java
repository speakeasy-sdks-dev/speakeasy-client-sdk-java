...
public class CheckAccessResponse implements io.github.speakeasy_sdks_staging.javaclientsdk.utils.Response {
     ...
     * HTTP response content type for this operation
     */
    public CheckAccessResponse withContentType(String contentType) {
        Utils.checkNotNull(contentType, "contentType");
        this.contentType = contentType;
        return this;
    }
     ...
     * Default error response
     */
    public CheckAccessResponse withError(io.github.speakeasy_sdks_staging.javaclientsdk.models.errors.Error error) {
        Utils.checkNotNull(error, "error");
     ...
     * Default error response
     */
    public CheckAccessResponse withError(Optional<? extends io.github.speakeasy_sdks_staging.javaclientsdk.models.errors.Error> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public CheckAccessResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CheckAccessResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CheckAccessResponse other = (CheckAccessResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CheckAccessResponse.class,
    ...
    public final static class Builder {
        ...
        public CheckAccessResponse build() {
