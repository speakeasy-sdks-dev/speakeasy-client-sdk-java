...
public class ApplyOperationIDsResponse implements Response {
     ...
     * Default error response
     */
    public ApplyOperationIDsResponse withError(Error error) {
        Utils.checkNotNull(error, "error");
     ...
     * Default error response
     */
    public ApplyOperationIDsResponse withError(Optional<? extends Error> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
